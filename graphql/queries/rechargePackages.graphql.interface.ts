...
export type RechargePackagesQuery = { __typename?: 'Query', rechargePackages: Array<{ __typename?: 'RechargePackage', id: string, amount: number, discountPercent: number }> };
 ...
 * });
 */
export function useRechargePackagesQuery(baseOptions?: Apollo.QueryHookOptions<RechargePackagesQuery, RechargePackagesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RechargePackagesQuery, RechargePackagesQueryVariables>(RechargePackagesDocument, options);
      }
export function useRechargePackagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RechargePackagesQuery, RechargePackagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
