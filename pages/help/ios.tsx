  ...
  return (
    ...
    >
      <div className="w-full space-y-4">
        ...
        <Image width={459} height={334} alt="How to paste in Foxray" src="https://vaslkon.com/file/optinetflow/asset/foxray-paste-link-1.png" />

        <p className='py-8'>۴. در صورت پرسش Allow paste را بزنید. بسته‌ی شما اضافه شده و می‌توانید با کلیک روی آیکن ▶ به آن وصل شوید.</p>
