      ...
      <div className="mx-auto my-12 flex max-w-xs flex-col justify-center" style={{ minHeight: "calc(100vh - 6rem)" }}>
        <div className="w-full space-y-4">
          ...
          <div className="mb-4 rounded bg-red-500 p-4 text-white">
            سلام دوستان خوبمون، متأسفانه به خاطر مشکل توی دیتاسنتر رسپینا (جایی که سرورهای ما هم اونجا هستن)، بعضی از
            کانفیگ‌ها دچار اختلال شدن و ممکنه شما هم اینو حس کرده باشید. 😔 ازتون بابت این مشکل عذرخواهی می‌کنیم و قول
            می‌دیم تیم فنی ما با تمام توان داره روی یه راه‌حل دائمی کار می‌کنه که دیگه چنین اتفاقاتی براتون پیش نیاد. 🙌
            ممنون که همیشه کنارمون هستید و با صبوری‌تون بهمون انرژی می‌دید! ❤️
          </div>
