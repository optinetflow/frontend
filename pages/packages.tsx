          ...
          packagesData?.packages?.map((pack) => (
            ...
            >
              <div className="flex h-full flex-col items-start justify-between">
                ...
                <span className="text-lg font-extrabold text-gray-900"> {pack.traffic} گیگ {formatDuration(pack.expirationDays)} </span>
                <span className="rounded-sm  text-xs text-slate-400">
                  چند کاربره
                  {/* {formatDuration(pack.expirationDays)} | چند کاربره */}
